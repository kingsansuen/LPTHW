...
number = [randint(0,9),randint(0,9),randint(0,9)]
convert = lambda nums: int(''.join(str(i) for i in nums))
pw = convert(number)
...
out. If you get the code wrong 1 times then the lock closes forever and you can't
get the bomb.
""")
...
bomb_death = Scene("Death...", "bomb_death", """
